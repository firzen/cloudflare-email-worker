...
describe("app", () => {
  ...
  it("serves the inbox UI shell at the root route", async () => {
    ...
    expect(body).toContain("id=\"current-password-input\"");
    expect(body).toContain("id=\"new-password-input\"");
    expect(body).toContain("id=\"confirm-password-input\"");
    expect(body).toContain("id=\"change-password-button\"");
